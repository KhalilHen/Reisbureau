...
<body>
    <header>
        ...
        <div class="login-container">
            <div class="login"><a href="home.php">Inloggen</a></div>
        </div>
    </header>
    ...
    <div class="login-box">
        <div class="boxshadow">
            <div class="login-tab">
                ...
                <input class="form-input" type="text" placeholder="E-mailadres of Emirates Skywards-nummer" required> <br>
                <a href="#">E-mailadres of accountnummer vergeten?</a> <br>
                <input class="form-input" type="password" placeholder="Wachtwoord" required> <br>
